                ...
                <div className="card-body">
                    <form ref={node => form = node}
                        ...
                        <div className="form-group row">
                            <label htmlFor="oldPassword" className="col-md-5 col-form-label">
                        ...
                        <div className="form-group row">
                            <label htmlFor="newPassword" className="col-md-5 col-form-label">
                        ...
                        <div className="form-group row">
                            <label htmlFor="confirmNewPassword" className="col-md- col-form-label">
