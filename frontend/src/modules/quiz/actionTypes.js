export const CREATE_QUIZ_COMPLETED =  "project/quiz/createQuizCompleted";
export const CHOOSE_ANSWER_COMPLETED =  "project/quiz/chooseAnswerCompleted";
export const GET_QUIZ_QUESTIONS_COMPLETED = "project/quiz/getQuizQuestionsCompleted";
export const GET_QUESTION_DETAILS_COMPLETED =  "project/quiz/getQuestionDetailsCompleted";
