...
public class SprintResultDTO {
    ...
    public SprintResultDTO(int position, String driverName, String driverNationality, String constructorName,
                           int grid, int laps, String time, double points, String status,
