...
export const createQuiz = ({ userId, lang, onSuccess, onCooldown, onErrors }) => dispatch =>
    backend.quizService.createQuiz(
        userId,
        lang,
        quiz => {
        ...
        secondsRemaining => {
            dispatch({ type: "QUIZ_COOLDOWN_ACTIVE", secondsRemaining });
