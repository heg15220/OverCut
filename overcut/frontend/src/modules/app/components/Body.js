...
import OvercutTrayectoria from "../../overcutTrayectoria/components/OvercutTrayectoria";
        ...
        <div className="Body">
            <Routes>
                <Route path="/">
                    ...
                    {loggedIn && <Route path="/minigames/trayectoria" element={withAdVignettes(<OvercutTrayectoria />, "games", "bottom")} />}
