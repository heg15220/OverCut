...
const CareerPathGame = () => {
  ...
  return (
    <AdWindows
      ...
      // ⚠️ IMPORTANTE: para que salga bottom sticky en móvil, NO lo desactives por prop
      // showBottomOnMobile no existe en AdWindows; se controla por CSS + consentimiento.
    >
