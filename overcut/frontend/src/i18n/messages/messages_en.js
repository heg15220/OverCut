const en = {
    ...
    'project.users.EmailConfirmationPending.title': 'Sign Up Complete!',
    'project.users.EmailConfirmationPending.message': 'Check your email and activate your account using the link before logging in.',
